...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    className={cn(
      "my-6 ml-6 list-disc [&_li]:mt-2 [&_ul]:ml-6 [&_ul]:list-[revert]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      `my-6 ml-6 list-decimal [counter-reset:section] [&_li]:mt-2 [&_li]:pl-1.5 [&_li]:[counter-increment:section] [&_li::marker]:[content:counters(section,'.')] [&_ol]:ml-6 [&_ol]:[counter-reset:section]`,
      className,
    )}
    {...props}
  />
...
const Muted = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ className, ...props }, ref) => (
    <small
      ref={ref}
